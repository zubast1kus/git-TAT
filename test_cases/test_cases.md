...
№ | Шаг | Результат |
-- | ------ | ----------- |
1 | Выбрать любую категорию товара и перейти на нее | Открылась страница категории выбранного товара |
2 | Выбрать любой товар и нажать на кнопку "В корзину" | Открылся поп-ап с текстом "Добавленно в корзину" и кнопками "Продолжить покупки","Оформить заказ" |
...
№ | Шаг | Результат |
-- | ------ | ----------- |
1 | Выбрать любую категорию товара и перейти на нее | Открылась страница категории выбранного товара, по умолчанию сортировка указана "По дате добавления" |
...
***
### Номер: 7
#### Заголовок: Функционал страницы товара
##### Предусловие: Открыта страница https://mobistore.by/catalog-main 
###### Приоритет: Средний
***
№ | Шаг | Результат |
-- | ------ | ----------- |
1 | Выбрать любую категорию товара и перейти на нее | Открылась страница категории выбранного товара |
2 | Выбрать любой товар и перейти на него | Открылась страница выбранного товара |
3 | На странице товара отметить чекбокс "сравнить товар" | Число товаров сравнения в нижнем левом углу увеличилось, чекбокс отметился |
4 | Нажать на кнопку "Нашли дешевле?" | Появилось всплывающее окно с полями для заполнения |
5 | Заполнить поля для ввода валидными данными и нажать кнопку отправить | Появилось всплывающее окно с подтверждением запроса |
6 | Нажать  на кнопку "Следить за ценой" | Появилось всплывающее окно с полями для заполнения |
7 | Заполнить поля для ввода валидными данными и нажать кнопку отправить | Появилось всплывающее окно с подтверждением запроса |
8 | В поле выбора цветов, меняем цвет на другой | Изображение изменилось в соответствии с выбором |
9 | Нажать на кнопку "В корзину" | Открылся поп-ап с текстом "Добавленно в корзину" и кнопками "Продолжить покупки","Оформить заказ" |
10 | Нажать на кнопку "Заказать в один клик" | Открылся поп-ап с полями для заполнения |
11 | Заполнить поля для ввода валидными данными и нажать кнопку отправить | Появилось всплывающее окно с подтверждением запроса |
12 | Нажать на кнопку "Купить в рассрочку" | Произошел подскрол к блоку "Рассрочка и кредит" |
***
### Номер: 8
#### Заголовок: Функционал рассрочки и кредита
##### Предусловие: Открыта страница https://mobistore.by/catalog-main 
###### Приоритет: Высокий
***
№ | Шаг | Результат |
...
1 | Выбрать любую категорию товара и перейти на нее | Открылась страница категории выбранного товара |
2 | Выбрать любой товар и перейти на него | Открылась страница выбранного товара |
3 | Нажать на кнопку "Купить в рассрочку" | Произошел подскрол к блоку "Рассрочка и кредит" |
4 | Выбрать срок кредитования  | Произшел перерасчет цены |
5 | Выбрать размер первого взноса  | Произшел перерасчет цены |
6 | Нажать на кнопку "Купить за N" | Открылся поп-ап с текстом "Добавленно в корзину" и кнопками "Продолжить покупки","Оформить заказ" |
***
### Номер: 9
#### Заголовок: Функционал галереи товара
##### Предусловие: Открыта страница любого товара
###### Приоритет: Низкий
***
№ | Шаг | Результат |
-- | ------ | ----------- |
1 | Пролистать все изображения товара в "карусели" | Изображения отображаются корректно |
2 | Выбрать любое изображение и нажать на него | Изображение открылось в увеличенном масштабе |
3 | Нажать на кнопку "X" в верхнем правом углу изображения | Изображение закрылось |
***
### Номер: 10
#### Заголовок: Функционал входа в свой аккаунт
##### Предусловие: Открыта любая страница сайта
###### Приоритет: Средний
***
№ | Шаг | Результат |
-- | ------ | ----------- |
1 | Нажать кнопку "Вход" | Открылась страница с полями для заполнения |
2 | Заполнить поля для ввода валидными данными | Данные в полях отобразились корректно |
3 | Нажать кнопку "Войти в личный кабинет" | Открылась главная страница сайта, в левом углу отобразился введенный никнейм |
***